...
public class SettingsScreen : MonoBehaviour
{
    ...
    private string _email = "ozcanalli@icloud.com";
    ...
    private void OnEnable()
    {
        ...
        _view.ArchiveClicked += ProcessArchiveClicked;
        _view.SubscriptionsClicked += ProcessShoppingClicked;
    ...
    private void ProcessArchiveClicked()
    {
        ArchiveClicked?.Invoke();
        _view.Disable();
    }

    private void ProcessShoppingClicked()
    {
